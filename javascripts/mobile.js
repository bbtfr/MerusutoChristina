...
(function() {
  ...
  App.Pages.UnitsIndex = (function(_super) {
    ...
    UnitsNavbarExtra.prototype.initDropdown = function() {
      var $age, $aarea, $country, countries, country, _i, _len, _results;
    $age = this.$("#age");
